    ...
    <section className="w-full py-8 bg-[#F9F6F1] overflow-visible">
      <div className="container mx-auto px-4 md:px-6 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-4 lg:gap-8 w-full max-w-6xl mx-auto">
          ...
          <ScrollAnimation animation="fade-right" duration={0.7} delay={0.1} className="order-1 lg:order-2">
          ...
          <ScrollAnimation animation="fade-left" duration={0.7} className="order-2 lg:order-1">
